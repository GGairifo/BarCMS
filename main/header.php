...
<header>
        ...
        <nav>
            <ul>
                <?php if ($is_admin): ?>
                    <li><a href='main/management.php' class='btn'>Management</a></li>
                <?php endif; ?>
                <?php if ($is_admin || $is_simpatizante): ?>
                    <li><a href="Bar/createBar.php" class='btn'>Criar Bar</a></li>
                <?php endif; ?>
                <?php if ($is_admin || $is_simpatizante ||$is_utilizador): ?>
                    <li><a href='main/logout.php' class='btn'>Logout</a></li>
                <?php endif; ?>
...
$(document).ready(function() {
        $('#searchButton').click(function() {
            ...
            var url = 'Bar/search_results.php?district=' + encodeURIComponent(district) + '&name=' + encodeURIComponent(name);
